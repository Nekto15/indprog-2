...
Figure::Figure() {
	std::cout << "Ââåäèòå çíà÷åíèÿ êîîðäèíàò X: ";
	std::cin >> this->x1;
	std::cin >> this->x2;
	std::cin >> this->x3;
	std::cin >> this->x4;
	std::cout << "Ââåäèòå çíà÷åíèÿ êîîðäèíàò Y: ";
	std::cin >> this->y1;
	std::cin >> this->y2;
	std::cin >> this->y3;
	std::cin >> this->y4;
...
void Figure::show() {
	std::cout << "Ñòîðîíà À = " << a.len() << " Ñòîðîíà B = " << b.len() << " Ñòîðîíà C = " << c.len() << " Ñòîðîíà D = " << d.len() << "\n";
	std::cout << "Ïåðèìåòð = " << this->P << " Ïëîùàäü = " << this->S;
}
