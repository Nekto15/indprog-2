...
Figure::Figure() {
	std::cout << "Введите значения координат X: ";
	std::cin >> this->x1;
	std::cin >> this->x2;
	std::cin >> this->x3;
	std::cin >> this->x4;
	std::cout << "Введите значения координат Y: ";
	std::cin >> this->y1;
	std::cin >> this->y2;
	std::cin >> this->y3;
	std::cin >> this->y4;
...
void Figure::show() {
	std::cout << "Сторона А = " << a.len() << " Сторона B = " << b.len() << " Сторона C = " << c.len() << " Сторона D = " << d.len() << "\n";
	std::cout << "Периметр = " << this->P << " Площадь = " << this->S;
}
